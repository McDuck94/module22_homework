...
// Константа для хранения об ошибке получения местоположения пользователя.
...
// Метод для получения текстового контейнера.
function getTextConteiner(message) {
